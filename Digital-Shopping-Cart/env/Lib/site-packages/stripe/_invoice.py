...
class Invoice(
            ...
            class UsBankAccount(StripeObject):
                class FinancialConnections(StripeObject):
                    permissions: Optional[
                        List[Literal["balances", "payment_method", "transactions"]]
                    ]
                    """
    ...
    class UpcomingParams(RequestOptions):
        ...
        """
        discounts: NotRequired["Literal['']|List[Invoice.UpcomingParamsDiscount]"]
        """
        ...
        """
        subscription_items: NotRequired["List[Invoice.UpcomingParamsSubscriptionItem]"]
        """
    ...
    class UpcomingParamsSubscriptionItem(TypedDict):
        ...
        """
        price_data: NotRequired["Invoice.UpcomingParamsSubscriptionItemPriceData"]
        """
    ...
    class UpcomingParamsCustomerDetails(TypedDict):
        address: NotRequired["Literal['']|Invoice.UpcomingParamsCustomerDetailsAddress"]
        """
        ...
        """
        tax_ids: NotRequired["List[Invoice.UpcomingParamsCustomerDetailsTaxId]"]
        """
    ...
    class UpcomingLinesParams(RequestOptions):
        ...
        The identifier of the customer whose upcoming invoice you'd like to retrieve. If `automatic_tax` is enabled then one of `customer`, `customer_details`, `subscription`, or `schedule` must be set.
        """
        customer_details: NotRequired["Invoice.UpcomingLinesParamsCustomerDetails"]
        """
        Details about the customer you want to invoice or overrides for an existing customer. If `automatic_tax` is enabled then one of `customer`, `customer_details`, `subscription`, or `schedule` must be set.
        """
        discounts: NotRequired["Literal['']|List[Invoice.UpcomingLinesParamsDiscount]"]
        """
        The coupons to redeem into discounts for the invoice preview. If not specified, inherits the discount from the customer or subscription. This only works for coupons directly applied to the invoice. To apply a coupon to a subscription, you must use the `coupon` parameter instead. Pass an empty string to avoid inheriting any discounts. To preview the upcoming invoice for a subscription that hasn't been created, use `coupon` instead.
        """
        ending_before: NotRequired["str"]
        ...
        Specifies which fields in the response should be expanded.
        """
        invoice_items: NotRequired["List[Invoice.UpcomingLinesParamsInvoiceItem]"]
        """
        List of invoice items to add or update in the upcoming invoice preview.
        """
        limit: NotRequired["int"]
    ...
    class UpcomingLinesParamsSubscriptionItem(TypedDict):
        ...
        The ID of the price object. When changing a subscription item's price, `quantity` is set to 1 unless a `quantity` parameter is provided.
        """
        price_data: NotRequired["Invoice.UpcomingLinesParamsSubscriptionItemPriceData"]
        """
        Data used to generate a new [Price](https://stripe.com/docs/api/prices) object inline.
        """
        quantity: NotRequired["int"]
    ...
    class UpcomingLinesParamsInvoiceItem(TypedDict):
        ...
        The ID of the price object.
        """
        price_data: NotRequired["Invoice.UpcomingLinesParamsInvoiceItemPriceData"]
        """
        Data used to generate a new [Price](https://stripe.com/docs/api/prices) object inline.
        """
        quantity: NotRequired["int"]
    ...
    class UpcomingLinesParamsCustomerDetails(TypedDict):
        ...
        The customer's tax exemption. One of `none`, `exempt`, or `reverse`.
        """
        tax_ids: NotRequired["List[Invoice.UpcomingLinesParamsCustomerDetailsTaxId]"]
        """
        The customer's tax IDs.
        """
    ...
    * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
    ...
    default_source: Optional[
        ExpandableField[Union["Account", "BankAccount", "CardResource", "Source"]]
    ]
    """
    ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
    """
    ...
    def _cls_pay(
        ...
        **params: Unpack[
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/invoices/{invoice}/pay".format(invoice=_util.sanitize_id(invoice)),
                api_key=api_key,
                stripe_version=stripe_version,
                stripe_account=stripe_account,
                params=params,
