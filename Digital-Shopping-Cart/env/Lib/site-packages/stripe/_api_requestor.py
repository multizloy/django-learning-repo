...
class APIRequestor(object):
        ...
        *,
        ...
        if method == "get" or method == "delete":
            ...
            if (
                ...
                and supplied_headers_dict.get("Content-Type") == "multipart/form-data"
            ):
        ...
        _util.log_info("Stripe API response", path=abs_url, response_code=rcode)
    ...
    def interpret_streaming_response(
        ...
        if self._should_handle_code_as_error(rcode):
            ...
            raise RuntimeError("interpret_response should have raised an error")
        else:
