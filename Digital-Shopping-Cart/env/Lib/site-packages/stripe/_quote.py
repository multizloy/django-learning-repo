...
class Quote(
    ...
    def _cls_accept(
        ...
        **params: Unpack[
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/quotes/{quote}/accept".format(quote=_util.sanitize_id(quote)),
                api_key=api_key,
    ...
    def _cls_cancel(
        ...
        **params: Unpack[
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/quotes/{quote}/cancel".format(quote=_util.sanitize_id(quote)),
                api_key=api_key,
                stripe_version=stripe_version,
                stripe_account=stripe_account,
                params=params,
    ...
    def _cls_finalize_quote(
        ...
        **params: Unpack[
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/quotes/{quote}/finalize".format(quote=_util.sanitize_id(quote)),
                api_key=api_key,
                stripe_version=stripe_version,
                stripe_account=stripe_account,
                params=params,
    ...
    def list(
        ...
        stripe_version: Optional[str] = None,
        stripe_account: Optional[str] = None,
        **params: Unpack["Quote.ListParams"]  # pyright: ignore[reportGeneralTypeIssues]
    ) -> ListObject["Quote"]:
        """
    ...
    def _cls_list_line_items(
        ...
        **params: Unpack[
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/quotes/{quote}/line_items".format(quote=_util.sanitize_id(quote)),
                api_key=api_key,
                stripe_version=stripe_version,
                stripe_account=stripe_account,
                params=params,
